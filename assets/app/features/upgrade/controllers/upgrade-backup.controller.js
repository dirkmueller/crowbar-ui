...
function() {
    ...
    UpgradeBackupController.$inject = ['$translate', '$state', 'upgradeBackupFactory', '$document'];
    // @ngInject
    function UpgradeBackupController($translate, $state, upgradeBackupFactory, $document) {
        var vm = this;
        vm.backup = {
            running: false,
            completed: false,
